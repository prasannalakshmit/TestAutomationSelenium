...
public class ScreenShot {
	...
	public static void main (String [] args) throws Exception{
  	  ...
  	  //System.setProperty("webdriver.firefox.driver", "C:\\Lakshmi\\TestAutomationSelenium\\Drivers\\IEDriverServer.exe");
      ...
      //driver.manage().window().maximize();
  	  ...
  	  try{
  		  ...
  		  driver.findElement(By.id("")).sendKeys("test automation");
